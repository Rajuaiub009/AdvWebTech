...
const router = useRouter();
      ...
      <>
       <div className="bg-blue-500 py-4">
        <div className="container mx-auto px-6">
            ...
            <h1 className="text-3xl text-center font-semibold text-white">Editors Details</h1>
            </div>
            </div>
   
   <center>
       <MyHeader title="Editors Details"/>
      ...
      <Image src={"http:/localhost:3001/author/geteimage/"+data.filename} alt="me" width="150" height="150" />
       <br></br>
       </div>
       </div>
    </div>
 ...
 const id=context.params.id;
    ...
    const response = await axios.get('http://localhost:3001/author/findeditor/'+id);
